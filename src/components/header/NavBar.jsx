            ...
            <div className="navbar-end">
                <div className="flex space-x-5 items-center">
                    ...
                    <div className="space-x-5">
                        <Link tabIndex={0} role="button" className="tooltip  tooltip-left  rounded-full" data-tip={"SignUp"} to='/signUp'>SignUp</Link>
                        <Link tabIndex={0} role="button" className="tooltip  tooltip-left  rounded-full" data-tip={"LogIn"} to='/logIn'>LogIn</Link>
                    </div>
                    {/* profile detials */}
                    <div>
                        <div className="dropdown">
